...
export async function POST(request: NextRequest) {
  ...
  return apiJson(projectToApi(created?.[0] ?? { ...project, owner_id: auth.userId, title: parsed.data.title, description: parsed.data.description, cover_image_url: null, mindmap_settings: null, ai_instructions: null, linked_spreadsheets: null, image_library: null, created_at: now, updated_at: now }), 201);
}
