...
export function productionFieldLabel(field: ProductionFieldKey): string {
  const labels: Record<ProductionFieldKey, string> = {
    ...
    maxOutput: "Output máximo",
    intervalSeconds: "Intervalo (s)",
    intervalSecondsMin: "Intervalo mín (s)",
    intervalSecondsMax: "Intervalo máx (s)",
    craftTimeSeconds: "Tempo de craft (s)",
    craftTimeSecondsMin: "Craft mín (s)",
    craftTimeSecondsMax: "Craft máx (s)",
    capacity: "Capacidade",
