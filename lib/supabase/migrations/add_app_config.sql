-- MODELO DE PLANO: N projetos e M páginas POR PROJETO. Não existe cota de páginas
-- somada entre projetos — cada projeto tem seu próprio teto. FREE_MAX_SECTIONS_TOTAL
-- foi removido do código; se a linha ainda existir na tabela, ela é ignorada.
--
...
INSERT INTO public.app_config (key, value, description) VALUES
  ...
  ('FREE_MAX_SECTIONS_PER_PROJECT', '300', 'Número máximo de páginas POR PROJETO (plano free)'),
...
--   SELECT 'FREE_MAX_SECTIONS_PER_PROJECT:' || id, '500', 'Override individual: fulano@exemplo.com'
