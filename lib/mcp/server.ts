...
function registerAddonTools(server: McpServer, api: ApiFetcher) {
  ...
  const esArraySource = z.object({ type: z.enum(["progressionTable", "craftTable", "productionIngredients", "productionOutputs", "skills", "skillCosts", "skillEffects", "sections"]), addonId: z.string().optional(), addonName: z.string().optional(), parentSectionId: z.string().optional(), parentSectionName: z.string().optional() });
