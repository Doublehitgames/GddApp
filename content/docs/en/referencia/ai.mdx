...
- That a GDD is organized into the **five canonical groups** (Overview, Design, Content, Presentation, Production)
- That important concepts get **their own page**, referenced with `$[...]` instead of repeated in the text
- That callouts have **4 intentional variants** (note / warning / design decision / balance note) — used with judgment
...
Each page comes with rich prose, callouts explaining jargon, and cross-references between subjects.
...
- Create new pages and reorganize the tree
- Update specific values
- Generate the export JSON on demand
- Build a page's flowchart from a description of the flow
...
<div className="grid gap-3 md:grid-cols-2 my-6 not-prose">
  <FeatureCard emoji="⌨️" title="Keyboard Shortcuts" href="/docs/referencia/atalhos">
    Reach the AI without leaving the keyboard.
  </FeatureCard>
