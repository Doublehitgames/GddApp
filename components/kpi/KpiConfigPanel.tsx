            ...
            {benchOpen && (
              <div className="px-3 pb-3 border-t border-gray-800/40">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
                  ...
                  <BenchmarkField label="D3" unit="%" defaultValue={baseBench.d3} customValue={customBenchmarks?.d3} onChange={(v) => patchBenchmark("d3", v)} goalLabel={t("kpi.config.benchmarkGoal")} minLabel={t("kpi.config.benchmarkMin")} resetLabel={t("kpi.config.benchmarkReset")} />
                  ...
                  <BenchmarkField label="D14" unit="%" defaultValue={baseBench.d14} customValue={customBenchmarks?.d14} onChange={(v) => patchBenchmark("d14", v)} goalLabel={t("kpi.config.benchmarkGoal")} minLabel={t("kpi.config.benchmarkMin")} resetLabel={t("kpi.config.benchmarkReset")} />
